...
$writer->writeSheetHeader('PerRowFormats', $header);
$writer->writeSheetRow(
    'PerRowFormats',
    array($pi, $pi, $pi, $pi, $pi, $pi, $pi, $pi, $pi)
);
$writer->writeSheetRowWithFormat(
    'PerRowFormats',
    array(
        'col1-date',
        'col2-datetime',
...
$writer->writeSheetRowWithFormat(
    'PerRowFormats',
    array($date, $date, $date, $date, $date, $date, $date, $date, $date),
    null,
    $row2format
);
$writer->writeSheetRowWithFormat(
    ...
    array(
        ...
        'col2-euro',
        'custom-amount1',
        'custom-amount2',//1 decimal place
        'custom-amount3',//2 decimal places
        'custom-currency1',//currency 2 decimal places, no currency/dollar sign
        'custom-currency2',//w/dollar sign
        'custom-currency3',//w/euro sign
        'custom-currency4', //japanese yen
        'custom-scientific'//-1.23E+003 scientific notation
    ),
    null,
    array('string')
);
$writer->writeSheetRowWithFormat(
    'PerRowFormats',
    array($amount, $amount, $amount, $amount, $amount, $amount, $amount, $amount, $amount, $amount),
    null,
    $row3format
);
$writer->writeToFile('xlsx-per-row-formats.xlsx');
